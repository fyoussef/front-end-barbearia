...
type DatepickerProps = {
  handleSelectedDate: (selectedDate: Date) => void
}

export function Datepicker({ handleSelectedDate }: DatepickerProps) {
  ...
  const isSameDay = (date: number) => date == Number(format(selectedDate, 'd'))
        ...
        <div className="mb-5 w-64">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              readOnly
              className="cursor-pointer w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium border-2"
