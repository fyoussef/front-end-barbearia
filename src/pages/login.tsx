    ...
    return (
        <>
            ...
            <div className="w-full h-screen flex justify-center items-center">
                <div className="w-96 flex flex-col space-y-8 border p-8 shadow-md rounded-md">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Forneça os dados necessários para efetuar o login</p>
                    </div>
                    ...
                    <div>
                        <p className="text-sm text-right">
                            <Link className=" underline hover:text-blue-500" href='/esqueci-minha-senha'>Esqueci minha senha</Link>
                        </p>
                    </div>
                    ...
                    <div>
                        <p className="text-sm text-center">
                            Ainda não possui uma conta? <Link className="underline hover:text-blue-500" href='/cadastro'>cadastre-se</Link>
                        </p>
                    </div>
