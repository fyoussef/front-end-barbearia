      ...
      <div className="w-full flex justify-center items-center py-4">
        <div className="w-96 flex flex-col space-y-8 border p-8 shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-500">Forneça os dados necessários para efetuar o seu cadastro</p>
          </div>
          ...
          <div>
            <p className="text-sm text-center">
              Já está cadastrado? <Link className="underline hover:text-blue-500" href='/login'>login</Link>
            </p>
          </div>
        </div>
      </div>
